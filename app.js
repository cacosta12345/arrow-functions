...
// 1a. this is the instance of Student that is Joe
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// 2a. this seems to be the whole window object
//
// 3. Explain why "this" is different when an arrow function is used.
// 3a. Per ChatGPT: In contrast, arrow functions do not have their own this binding. Instead, they inherit the this value from the enclosing scope (the context in which the arrow function is defined). This is sometimes referred to as lexical scoping. Arrow functions are especially useful in situations where you want to preserve the value of this from the surrounding code.